<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('id_usuario', $inventario->id_usuario, ['class' => 'form-control' . ($errors->has('id_usuario') ? ' is-invalid' : ''), 'placeholder' => 'Id Usuario']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::text('tipo_Transaccion', $inventario->tipo_Transaccion, ['class' => 'form-control' . ($errors->has('tipo_Transaccion') ? ' is-invalid' : ''), 'placeholder' => 'Tipo Transaccion']) }}
